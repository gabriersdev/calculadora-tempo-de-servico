...
const principal = `<div class="principal"> <header class="mb-5"> <h1>Calculadora</h1> <h1>Tempo de Serviço</h1> </header> <main class="row"> <section class="col"> <div class="card"> <div class="card-header"> <b>Períodos de serviço</b> </div> <div class="card-body"> <div class="alert alert-warning mb-3"><b>Atenção:</b> A calculadora não ignora vínculos simultâneos. </div> <form action="" data-element="formulario"> <div data-element="periodos"> <div class="row mb-3" data-element="periodo"> <div class="col input-group"> <label class="input-group-text" for="inicio-periodo-0">Início</label> <input type="text" inputmode="numeric" placeholder="00/00/0000" class="form-control" id="inicio-periodo-0" oninput="escutaEventoInput(this)" data-element="inicio" required pattern="\d{2}/\d{2}/\d{4}" title="O formato deve corresponder a uma data. Ex.: 01/01/2000"> </div> <div class="col input-group"> <label class="input-group-text" for="fim-periodo-0">Fim</label> <input type="text" inputmode="numeric" placeholder="00/00/0000" class="form-control" id="fim-periodo-0" oninput="escutaEventoInput(this)" data-element="fim" required pattern="\d{2}/\d{2}/\d{4}" title="O formato deve corresponder a uma data. Ex.: 01/01/2000"> <button class="btn btn-outline-secondary" type="button" onclick="removerPeriodo(this)" data-toggle="tooltip" data-placement="top" title="Remover"><i class="bi bi-x-lg"></i></button> </div> </div> </div> <div class="d-flex justify-content-between align-center"> <button type="button" class="btn btn-light" data-action="adicionar-periodo">Adicionar período</button> <button type="submit" class="btn btn-primary" data-action="calcular">Calcular</button> </div> </form> </div> </div> </section> <section class="col"> <div class="card"> <div class="card-header d-flex justify-content-between align-items-center"> <b>Tempo de serviço</b> <div><button class="btn btn-light" data-toggle="tooltip" data-placement="top" data-action="baixar-resultados" title="Baixar resultado"><i class="bi bi-file-earmark-arrow-down"></i></button>&nbsp;<button class="btn btn-light" data-toggle="tooltip" data-placement="top" data-action="alternar-visualizacao" title="Alternar visualização"><i class="bi bi-card-heading"></i></button></div></div> <div class="card-body"> <div class="alert alert-secondary" data-content="informacao-funcionamento"> O tempo de serviço calculado aparece aqui. </div> <div data-content="demais-informacoes"><h4><b data-content="meses-calculo"></b></h4> <span class="text-muted" data-content="dados-calculo-detalhado"></span><ul class="mt-4 none" data-element="critica-tempo-de-servico-erro"> </ul><ul class="mt-4 none" data-element="critica-tempo-de-servico-sucesso"> </ul><div class="mt-4 alert alert-primary none" data-element="saiba-mais"> <b>Saiba mais</b>&nbsp;<a href="" class="link-visivel" data-link="saiba-mais-uso">sobre a utilização do FGTS em financiamentos habitacionais.</a> </div> <div class="none mt-4" data-element="referencia"> <small class="text-muted"><sup>1</sup>&nbsp;A amortização de financiamentos habitacionais pode ser realizada a cada 2 anos, após o imóvel pronto em caso de empreendimento. <a href="" data-link="saiba-mais" class="link-visivel">Saiba mais clicando aqui.</a></small> </div></div>  
  <div class="card-tempo-de-servico none" data-content="card-resultado">
    <div class="tempo">
      <h3 class="tempo-titulo" data-content="meses-calculo">284</h3>
      <h3 class="tempo-descricao">meses trabalhados</h3>
    </div>
    <div class="descricao">
