...
<input type="text" placeholder="00/00/0000" class="form-control" id="inicio-periodo-${index}" oninput="escutaEventoInput(this)" data-element="inicio" required pattern="\d{2}/\d{2}/\d{4}" title="O formato deve corresponder a uma data. Ex.: 01/01/2000">
</div>
<div class="col input-group">
<label class="input-group-text" for="fim-periodo-${index}">Fim</label>
<input type="text" placeholder="00/00/0000" class="form-control" id="fim-periodo-${index}" oninput="escutaEventoInput(this)" data-element="fim" required pattern="\d{2}/\d{2}/\d{4}" title="O formato deve corresponder a uma data. Ex.: 01/01/2000">
