...
<input type="date" placeholder="00/00/0000" class="form-control" id="inicio-periodo-${index}" oninput="escutaEventoInput(this)" data-element="inicio" required>
</div>
<div class="col input-group">
<label class="input-group-text" for="fim-periodo-${index}">Fim</label>
<input type="date" placeholder="00/00/0000" class="form-control" id="fim-periodo-${index}" oninput="escutaEventoInput(this)" data-element="fim" required>
